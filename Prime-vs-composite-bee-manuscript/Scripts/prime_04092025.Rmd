...
#Subset Experiment 1 grouped data
...
#Subset Experiment 3 training data
...
lm_ext4_primeconfintlow <-(exp(0.03109655)/(1 + exp(0.03109655)))
lm_ext4_primeconfinthigh <-(exp(1.0915254)/(1 + exp(1.0915254)))

confint(lm_ext4_composite)
lm_ext4_compositeconfintlow <-(exp(-0.1256052)/(1 + exp(-0.1256052)))
lm_ext4_compositeconfinthigh <-(exp(0.9778516)/(1 + exp(0.9778516)))

confint(lm_ext5_prime)
lm_ext5_primeconfintlow <-(exp(-0.1896967)/(1 + exp(-0.1896967)))
lm_ext5_primeconfinthigh <-(exp(0.7046346)/(1 + exp(0.7046346)))

confint(lm_ext6_composite)
lm_ext6_compositeconfintlow <-(exp(-0.08221807)/(1 + exp(-0.08221807)))
lm_ext6_compositeconfinthigh <-(exp(1.298001)/(1 + exp(1.298001)))
print(lm_ext6_compositeconfintlow)
print(lm_ext6_compositeconfinthigh)

confint(lm_ext6_prime)
lm_ext6_primeconfintlow <-(exp(-0.4444105)/(1 + exp(-0.4444105)))
lm_ext6_primeconfinthigh <-(exp(0.5816044)/(1 + exp(0.5816044)))
print(lm_ext6_primeconfintlow)
print(lm_ext6_primeconfinthigh)
